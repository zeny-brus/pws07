...
def calcula_equilibrio_financeiro():
    ...
    try:
        percent_gastos_essenciais = total_gastos_essenciais*100/total
        percent_gastos_nao_essenciais = total_gastos_nao_essenciais*100/total
        return percent_gastos_essenciais, percent_gastos_nao_essenciais
    except:
        return 0, 0